...
| `hostUsers`                                      | If set to `false`, the pod will use user namespaces for additional isolation. This may not be supported on all kubernetes distributions.    | `nil`                                                                          |
...
| `tls.certManager.existingIssuer.group`           | API group of the existing cert-manager issuer (e.g. `awspca.cert-manager.io` for aws-privateca-issuer)                                                                                                                                                            | `"cert-manager.io"`                                                            |
